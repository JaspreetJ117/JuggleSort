...
public class JuggleSortTest {
    ...
    public static void main(String[] args) {
        // Test 1
        System.out.println(JuggleSort.juggleSort(List.of(3, 5, 1, 8, 2, 7)));

        // Test 2
        System.out.println(JuggleSort.juggleSort(createRandom(9)));

        // Test 3
        System.out.println(JuggleSort.juggleSort(List.of(3, 5, 1, 1, 2, 7)));

        // Test 4 
        System.out.println(JuggleSort.juggleSort(createRandom(10)));
    }
}
